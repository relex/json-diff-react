...
export const colorize = function (diff, options = {}, customization) {
    ...
    colorizeToCallback(diff, options, function (color, line) {
        ...
        let renderedLine = (_jsx("div", Object.assign({ className: className, style: style }, { children: line + '\r\n' }), output.length));
        return output.push(renderedLine);
    });
    return (_jsx("div", Object.assign({ className: customization.frameClassName, style: customization.frameStyle }, { children: _jsx("pre", { children: output }) })));
};
